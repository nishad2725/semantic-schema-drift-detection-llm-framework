...
def generate_report(schema: list[ColumnProfile], column_drift: DriftInsight,
                   distributions: list[DriftInsight], patterns: list[DriftInsight], 
                   summary: DriftInsight, output_path: str) -> None:
    """
    Generate a drift detection report.
    
    Args:
        schema: Schema profiles
        column_drift: Column drift insight
    ...
    report = {
        ...
        "column_drift": column_drift.model_dump(),
